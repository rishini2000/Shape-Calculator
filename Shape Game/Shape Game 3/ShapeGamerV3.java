...
public class ShapeGamerV3{
    ...
    public static void main(String [] args){
        ...
        if(op==1){
            ...
            area = CalFunctionV2.getRecArea(wdt, hgt);
            peremeter = CalFunctionV2.getRecPere(wdt, hgt);
            ...
            double rds = Double.parseDouble(radius);

            area = CalFunctionV2.getCirArea(rds);
            peremeter = CalFunctionV2.getCirPere(rds);
            ...
            area = CalFunctionV2.getTraArea(base , vhgt);
            peremeter = CalFunctionV2.getTraPere(base , sde1 , sde2);
